# Image Preprocessing Assignment (1차) + 2D → 3D & Unit Test (2차)

Repository: https://github.com/wsbang0002/image-preprocessing-assignment

---

## 1차 과제: 이미지 전처리 (Hugging Face `ethz/food101`)
